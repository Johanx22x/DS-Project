...
Climate *climates = new Climate("1", 2.3, 4.1, 8.2, 0.4, 31.8, 'N', true, 0, 1,
                                2, rains, places, people);
...
int main() {
  ...
  reports->addItem(new MenuItem(0, "Back", [](Menu *, Menu *) -> CommandCodes {
  ...
  dataManagement->addItem(new MenuItem(
      ...
      [](Menu *dataManagement, Menu *) -> CommandCodes {
        ...
        while (true) {
          ...
          if (instants->search(name) == nullptr) {
            break;
          }
  ...
  dataManagement->addItem(new MenuItem(
      ...
      [](Menu *dataManagement, Menu *) -> CommandCodes {
        ...
        while (true) {
          ...
          if (climates->search(climateId) == nullptr) {
            break;
          }
  ...
  dataManagement->addItem(new MenuItem(
      7, "Add a new place", [](Menu *dataManagement, Menu *) -> CommandCodes {
        if (regions == nullptr) {
  ...
  dataManagement->addItem(new MenuItem(
      4, "Add a new region", [](Menu *dataManagement, Menu *) -> CommandCodes {
  ...
  dataManagement->addItem(new MenuItem(
      1, "Add a new person", [](Menu *dataManagement, Menu *) -> CommandCodes {
        printf("\n");
  ...
  menu->addItem((new MenuItem(3, "Show reports options",
                              [](Menu *menu, Menu *reports) -> CommandCodes {
                                reports->display();
                                while (reports->prompt() ==
                                       CommandCodes::CONTINUE)
                                  ;
                                menu->display();
                                return CommandCodes::CONTINUE;
                              }))
                    ->withMenu(reports));
  menu->addItem(
      (new MenuItem(2, "Show consultations options",
  ...
  menu->addItem(
      (new MenuItem(1, "Show data options",
  ...
  menu->addItem(new MenuItem(0, "Exit", [](Menu *, Menu *) -> CommandCodes {
