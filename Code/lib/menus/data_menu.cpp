...
MenuItem *dataItems[] = {
    ...
    new MenuItem(
        14, "Modify a registered instant",
        [](Menu *, Program *ctx) -> CommandCodes {
          ...
          if (option == 2) {
            ...
            printf("Are you sure you want do delete \u001b[34m%s\u001b[0m? "
                   "[y/n]: ",
                   toModify->name.c_str());
            // Flush buffer
            std::cin.clear();
          ...
          while (modifyFlag) {
            ...
            case 3: {
              printf("Enter the new start time for the instant (24 hours "
                     "format)\n");
            ...
            case 4: {
              printf(
                  "Enter the new end time for the instant (24 hours format)\n");
    ...
    new MenuItem(
        11, "Modify a registered climate",
        [](Menu *, Program *ctx) -> CommandCodes {
          if (ctx->climates == nullptr) {
            ...
            case 12: {
              ...
              case 3: {
                double rainfall = getDouble(
                    "Enter the new average mm rainfall value of the rain");
                while (rainfall < 0 || rainfall > 10) {
                  eprint("The rainfall value must be between 0 and 10");
                  rainfall = getDouble(
                      "Enter the average mm rainfall value of the rain");
                }
              }
              default:
                break;
    ...
    new MenuItem(
        10, "Add a new climate to the register",
        [](Menu *, Program *ctx) -> CommandCodes {
          ...
          double rainfall =
              getDouble("Enter the average mm rainfall value of the rain");
          while (rainfall < 0 || rainfall > 10) {
            eprint("The rainfall value must be between 0 and 10");
            rainfall =
                getDouble("Enter the average mm rainfall value of the rain");
          ...
          Climate *newClimate =
              new Climate(climateId, precipitation, maxTemp, minTemp, windSpeed,
                          humidity, windDirection, itRained, date, startTime,
    ...
    new MenuItem(
        ...
        [](Menu *, Program *ctx) -> CommandCodes {
          ...
          while (modifyFlag) {
            ...
            case 2: {
              int population =
                  getInt("Enter the new population value for the place");
            ...
            case 3: {
              double area =
                  getDouble("Enter the new area for the region register");
              toModify->area = area;
    ...
    new MenuItem(
        ...
        [](Menu *, Program *ctx) -> CommandCodes {
          ...
          while (true) {
            ...
            printf(
                "\u001b[31mThis place already exist! Choose another place or "
    ...
    new MenuItem(4, "Add a new region",
                 [](Menu *, Program *ctx) -> CommandCodes {
                   ...
                   if (ctx->regions == nullptr) {
                     ...
                     ctx->regions =
                         insert(ctx->regions, new Region(name, id, location));
                   }
    ...
    new MenuItem(
        ...
        [](Menu *, Program *ctx) -> CommandCodes {
          ...
          if (option == 2) {
            std::string attributeModify;
            printf("Are you sure you want do delete \u001b[34m%s %s\u001b[0m? "
                   "[y/n]: ",
          ...
          while (modifyFlag) {
            ...
            case 3: {
              ...
              while (newAge < 12 || newAge > 125) {
                printf("\u001b[31mThe person's age must be an integer value "
                       "between 12 and 125!\u001b[0m\n");
    ...
    new MenuItem(1, "Add a new person",
                 [](Menu *, Program *ctx) -> CommandCodes {
                   printf("\n");
                   ...
                   while (age < 12 || age > 125) {
                     printf("\u001b[31mThe person's age must be an integer "
                            "value between 12 and 125!\u001b[0m\n");
